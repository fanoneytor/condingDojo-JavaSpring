...
import com.codingdojo.stefano.repositorios.TaskRepository;
...
public class AppService {
	...
	public Task guardarTarea(Task nuevaTarea) {
		return repoTask.save(nuevaTarea);
	}
	
	public Task tareaPorId(Long id) {

...
<body>
	<div class="container">
		...
		<form:form action="/tasks/update" method="POST" modelAttribute="tarea">
			...
			<form:hidden path="creator" value="${task.creator}"></form:hidden>
			
			<form:hidden path="taskOwner" value="${task.taskOwner}"></form:hidden>
